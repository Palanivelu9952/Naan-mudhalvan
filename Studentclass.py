...
rollNumber, double cgpa) {
  ...
  Comparator<Student> {
    ...
    Student student2) {
        ...
        return Double.compare(student2.cgpa,
    student1.cgpa);
    }
  }
  // Function to sort a list of student objects
based on CGPA in descending order
  static void sortStudents(List<Student>
students) {
  // Use the CGPAComparator to sort the
list
...
Students by CGPA (Descending Order):");
  for (Student student : students) {
    System.out.println("Name: " +
  student.name + ", Roll Number: " +
  student.rollNumber +", CGPA: " +
  student.cgpa);
      }
    }
  }
